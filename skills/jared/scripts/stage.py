...
# The pullability classifier and its acceptance-section regexes live in
# `lib/pullable.py` (#429) so sweep.py can ask the same question and get the
# same answer. They are imported above and re-exported implicitly: tests and
# callers still reach them as `stage.is_pullable` etc.
