...
> **Environment (worktree).** This work runs in the session-2 worktree `/home/user/Code/jared-318`, which has **no `.venv`** (it's gitignored and lives only in the main repo). Every command below uses the main repo's venv binaries while keeping CWD in the worktree: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -m pytest …`. With CWD in the worktree, pytest's `pythonpath=["."]` puts the worktree root first, so the code under test is the worktree's — which also avoids the main-repo-import pitfall where invoking `skills/jared/scripts/jared` would load the main repo's `lib/`.
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -c "from skills.jared.scripts.lib.board_provider import Comment, BoardProvider; print(Comment(author='a', body='b', created_at='c'))"`
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -m pytest tests/test_provider_comments.py -q`
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -m pytest tests/test_provider_comments.py -k kanbanflow -q`
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/ruff check . && /home/user/Code/jared/.venv/bin/ruff format --check . && /home/user/Code/jared/.venv/bin/mypy && /home/user/Code/jared/.venv/bin/python -m pytest -q`
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -m pytest tests/test_migrate_core.py -q`
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -m pytest tests/test_migrate_core.py -k "number_map or cross_refs" -q`
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -m pytest tests/test_migrate_core.py -k "edges or estimate" -q`
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -m pytest tests/test_migrate_core.py -q && /home/user/Code/jared/.venv/bin/ruff check skills/jared/scripts/lib/migrate.py && /home/user/Code/jared/.venv/bin/mypy`
Expected: PASS + clean.
...
Run: `cd /home/user/Code/jared-318 && /home/user/Code/jared/.venv/bin/python -m pytest tests/test_cmd_migrate.py -q`
