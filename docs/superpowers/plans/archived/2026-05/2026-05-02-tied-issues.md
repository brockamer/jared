...
```bash
/home/user/Code/jared/skills/jared/scripts/jared ties 52
```
...
```bash
/home/user/Code/jared/skills/jared/scripts/jared move 52 Backlog
```
...
EOF
/home/user/Code/jared/skills/jared/scripts/jared comment 77 --body-file /tmp/77-smoke.md
```
...
EOF
/home/user/Code/jared/skills/jared/scripts/jared file \
